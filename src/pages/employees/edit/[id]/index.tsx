      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        ...
        {isLoading || (!formik.values && !error) ? (
          ...
          <form onSubmit={formik.handleSubmit}>
            ...
            <FormControl id="vacation_balance" mb="4" isInvalid={!!formik.errors?.vacation_balance}>
              <FormLabel>Vacation Balance</FormLabel>
              <NumberInput
              ...
              {formik.errors.vacation_balance && <FormErrorMessage>{formik.errors?.vacation_balance}</FormErrorMessage>}
            </FormControl>
